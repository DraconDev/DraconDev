...
Tools that solve a job directly:
...
- [**folder-auto-banner**](https://github.com/DraconDev/folder-auto-banner) — contextual directory dashboard; `ls` with git, TODO, ports, Docker, build, and cached size context.
- [**tiles-tui-file-manager**](https://github.com/DraconDev/tiles-tui-file-manager) — dual-pane TUI file manager with git, SSH, editor, and system monitor.
- [**obs-wayland-hotkey**](https://github.com/DraconDev/obs-wayland-hotkey) — OBS hotkey daemon for Wayland/X11; crates.io + CI.
- [**youtube-video-uploader**](https://github.com/DraconDev/youtube-video-uploader) — Rust YouTube API client + CLI for resumable uploads.

## GitHub pin focus

GitHub profile pins can pin repositories, not subdirectories. The target pin set is concrete component-level work rather than a vague parent bucket:

- [`dracon-sync`](https://github.com/DraconDev/dracon-utilities/tree/main/dracon-sync) — invisible Git sync for AI-powered development; link to the subdirectory until it is split/published as a separate public repo.
- [`dracon-system`](https://github.com/DraconDev/dracon-utilities/tree/main/dracon-system) — proactive disk/process guard; link to the subdirectory until it is split/published as a separate public repo.
- [`dracon-warden`](https://github.com/DraconDev/dracon-utilities/tree/main/dracon-warden) — Git secret encryption and repo hardening; link to the subdirectory until it is split/published as a separate public repo.
- [`tiles-tui-file-manager`](https://github.com/DraconDev/tiles-tui-file-manager) — concrete usable TUI file manager.
- [`folder-auto-banner`](https://github.com/DraconDev/folder-auto-banner) — contextual directory dashboard.
- [`obs-wayland-hotkey`](https://github.com/DraconDev/obs-wayland-hotkey) — concrete OBS hotkey daemon with Wayland/X11 value.

Do not spend a GitHub pin slot on the parent `dracon-utilities` bucket while the three component repos are still subdirectories.
