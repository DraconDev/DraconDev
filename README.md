...
### 3. 🛸 THE SIMULATION: [Junk-Runner](./SOVEREIGN_SIMULATION.md)
...
### 4. 🧬 THE DNA: [dracon-libs](./SOVEREIGN_ENGINEERING.md)
...
- **[INTERFACE LAYER](./SOVEREIGN_ENGINEERING.md):** Tiles (Data Commander) + Axiom UI (AI-First UI) + Terma (TUI Engine).
