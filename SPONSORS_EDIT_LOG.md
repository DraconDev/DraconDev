...
- Direct attempt to call a hypothetical `updateSponsorsListing` mutation returned `Field 'updateSponsorsListing' doesn't exist on type 'Mutation'` and `UpdateSponsorsListingInput isn't a defined input type`; evidence: `/tmp/update_sponsors_listing_attempt.json`.
...
- Sponsorship goal API availability was checked (`/tmp/github_sponsors_goal_search.txt`): public GraphQL exposes `SponsorsListing.activeGoal` and `SponsorsGoal` as read-only fields; no create/update/retire goal mutation is present, and GitHub docs route goal editing through the dashboard.
...
- Retired the previous five fixed tiers with `retireSponsorsTier`:
  ...
  - Response log: `/tmp/reti[DRACON_SECRET:].jsonl`
...
### Final t3dotgg-style update audit

- `/tmp/dracon_sponsors_t3_final_audit.txt`
- `/tmp/dracon_sponsors_t3_final_audit.sh`
- `/tmp/dracon_sponsors_t3_git_status.txt`
